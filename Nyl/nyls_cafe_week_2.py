...
def add_product(to_add): 
    if to_add not in product_list:
        print(f"{to_add} added to list. Returning to main menu.")
        return product_list.append(to_add)
    else: print("Product already in list. Returning to main menu.")


# update order status options
order_status_options = ["preparing", "dispatched", "delivered", "cancelled"]

# CREATE menu that accepts user input
...
while True:
    ...
    # ENTER product menu
        ...
        # UPDATE product
                ...
                print(f"Product list updated. Returning to product menu.")
                sleep(2)
                system("cls")
        ...
        # DELETE product
                ...
                print(f"You have deleted {product_list[to_delete]}. Returning to main menu.")
